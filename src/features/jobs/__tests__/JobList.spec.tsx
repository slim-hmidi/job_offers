...
describe('Job list', () => {
  ...
  test('Should returns a message when the jobs list is empty', async () => {
    ...
    expect(
      await screen.findByText(/No matching jobs found!/),
    ).toBeInTheDocument()
  })
          ...
          ctx.json([
            {
              ...
              type: 'Full Time',
              url:
                'https://jobs.github.com/positions/10dddabd-2b7d-4503-b70b-30f1a78b464b',
  ...
  test('Should returns a message if the there is no fullTime', async () => {
    ...
    expect(
      await screen.findByText(/No matching jobs found!/i),
    ).toBeInTheDocument()
  })
